...
AdjList buildGraph() {
  ...
  auto add = [&](const string &from, Edge e) { g[from].push_back(std::move(e)); };
  ...
  add("Kohat Enclave",
      {"Netaji Subhash Place", 2, 11, 1.1, "Red Line", "L1", false});
  add("Netaji Subhash Place",
      {"Kohat Enclave", 2, 11, 1.1, "Red Line", "L1", false});
  add("Netaji Subhash Place",
      {"Keshav Puram", 2, 11, 1.2, "Red Line", "L1", false});
  add("Netaji Subhash Place", {"Netaji Subhash Place", 5, 0, 0.0, "Pink Line",
                               "L7", true}); // interchange
  add("Keshav Puram",
      {"Netaji Subhash Place", 2, 11, 1.2, "Red Line", "L1", false});
  ...
  add("Inderlok",
      {"Inderlok", 4, 0, 0.0, "Green Line", "L5", true}); // interchange
  ...
  add("Kashmere Gate",
      {"Kashmere Gate", 5, 0, 0.0, "Yellow Line", "L2", true}); // interchange
  add("Kashmere Gate",
      {"Kashmere Gate", 5, 0, 0.0, "Violet Line", "L6", true}); // interchange
  ...
  add("Welcome",
      {"Welcome", 5, 0, 0.0, "Pink Line", "L7", true}); // interchange
  ...
  // ═══════════════════════════════════════════════════════════════
  add("Samaypur Badli",
      {"Rohini Sector 18, 19", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Rohini Sector 18, 19",
      {"Samaypur Badli", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Rohini Sector 18, 19",
      {"Haiderpur Badli Mor", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Haiderpur Badli Mor",
      {"Rohini Sector 18, 19", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Haiderpur Badli Mor",
      {"Jahangirpuri", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Jahangirpuri",
      {"Haiderpur Badli Mor", 2, 11, 1.2, "Yellow Line", "L2", false});
  ...
  add("Azadpur",
      {"Azadpur", 5, 0, 0.0, "Pink Line", "L7", true}); // interchange
  ...
  add("Vishwavidyalaya",
      {"Vidhan Sabha", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Vidhan Sabha",
      {"Vishwavidyalaya", 2, 11, 1.1, "Yellow Line", "L2", false});
  ...
  add("Chandni Chowk",
      {"Kashmere Gate", 2, 11, 1.3, "Yellow Line", "L2", false});
  add("Chandni Chowk",
      {"Chawri Bazaar", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Chawri Bazaar",
      {"Chandni Chowk", 2, 11, 1.1, "Yellow Line", "L2", false});
  ...
  add("New Delhi",
      {"New Delhi", 3, 0, 0.0, "Airport Express", "AEL", true}); // interchange
  add("Rajiv Chowk", {"New Delhi", 2, 11, 0.8, "Yellow Line", "L2", false});
  add("Rajiv Chowk", {"Patel Chowk", 2, 11, 1.0, "Yellow Line", "L2", false});
  add("Rajiv Chowk",
      {"Rajiv Chowk", 5, 0, 0.0, "Blue Line", "L3", true}); // interchange
  add("Patel Chowk", {"Rajiv Chowk", 2, 11, 1.0, "Yellow Line", "L2", false});
  add("Patel Chowk",
      {"Central Secretariat", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Central Secretariat",
      {"Patel Chowk", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Central Secretariat",
      {"Udyog Bhawan", 2, 11, 1.0, "Yellow Line", "L2", false});
  add("Central Secretariat", {"Central Secretariat", 5, 0, 0.0, "Violet Line",
                              "L6", true}); // interchange
  add("Udyog Bhawan",
      {"Central Secretariat", 2, 11, 1.0, "Yellow Line", "L2", false});
  add("Udyog Bhawan",
      {"Lok Kalyan Marg", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Lok Kalyan Marg",
      {"Udyog Bhawan", 2, 11, 1.2, "Yellow Line", "L2", false});
  ...
  add("Hauz Khas",
      {"Hauz Khas", 5, 0, 0.0, "Magenta Line", "L8", true}); // interchange
  ...
  add("Arjangarh",
      {"Guru Dronacharya", 2, 11, 1.4, "Yellow Line", "L2", false});
  add("Guru Dronacharya",
      {"Arjangarh", 2, 11, 1.4, "Yellow Line", "L2", false});
  add("Guru Dronacharya",
      {"Sikanderpur", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Sikanderpur",
      {"Guru Dronacharya", 2, 11, 1.2, "Yellow Line", "L2", false});
  add("Sikanderpur", {"MG Road", 2, 11, 1.1, "Yellow Line", "L2", false});
  add("Sikanderpur", {"Sikanderpur", 4, 0, 0.0, "Rapid Metro Gurgaon", "RMG",
                      true}); // interchange
  ...
  add("IFFCO Chowk",
      {"HUDA City Centre", 2, 11, 1.4, "Yellow Line", "L2", false});
  add("HUDA City Centre",
      {"IFFCO Chowk", 2, 11, 1.4, "Yellow Line", "L2", false});

  // ═══════════════════════════════════════════════════════════════
  // LINE 3 — BLUE LINE
  // Dwarka Sector 21 ↔ Vaishali (main) + branch to Noida Electronic City
  // ═══════════════════════════════════════════════════════════════
  add("Dwarka Sector 21",
      {"Dwarka Sector 8", 2, 11, 1.3, "Blue Line", "L3", false});
  add("Dwarka Sector 21", {"Dwarka Sector 21", 3, 0, 0.0, "Airport Express",
                           "AEL", true}); // interchange
  add("Dwarka Sector 8",
      {"Dwarka Sector 21", 2, 11, 1.3, "Blue Line", "L3", false});
  add("Dwarka Sector 8",
      {"Dwarka Sector 9", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 9",
      {"Dwarka Sector 8", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 9",
      {"Dwarka Sector 10", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 10",
      {"Dwarka Sector 9", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 10",
      {"Dwarka Sector 11", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Dwarka Sector 11",
      {"Dwarka Sector 10", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Dwarka Sector 11",
      {"Dwarka Sector 12", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 12",
      {"Dwarka Sector 11", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 12",
      {"Dwarka Sector 13", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 13",
      {"Dwarka Sector 12", 2, 11, 0.9, "Blue Line", "L3", false});
  add("Dwarka Sector 13",
      {"Dwarka Sector 14", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Dwarka Sector 14",
      {"Dwarka Sector 13", 2, 11, 1.0, "Blue Line", "L3", false});
  ...
  add("Uttam Nagar West",
      {"Uttam Nagar East", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Uttam Nagar East",
      {"Uttam Nagar West", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Uttam Nagar East",
      {"Janakpuri West", 2, 11, 1.2, "Blue Line", "L3", false});
  add("Janakpuri West",
      {"Uttam Nagar East", 2, 11, 1.2, "Blue Line", "L3", false});
  add("Janakpuri West",
      {"Janakpuri East", 2, 11, 1.1, "Blue Line", "L3", false});
  add("Janakpuri West",
      {"Janakpuri West", 5, 0, 0.0, "Magenta Line", "L8", true}); // interchange
  add("Janakpuri East",
      {"Janakpuri West", 2, 11, 1.1, "Blue Line", "L3", false});
  ...
  add("Tagore Garden",
      {"Rajouri Garden", 2, 11, 1.1, "Blue Line", "L3", false});
  add("Rajouri Garden",
      {"Tagore Garden", 2, 11, 1.1, "Blue Line", "L3", false});
  add("Rajouri Garden", {"Ramesh Nagar", 2, 11, 1.2, "Blue Line", "L3", false});
  add("Rajouri Garden",
      {"Rajouri Garden", 5, 0, 0.0, "Pink Line", "L7", true}); // interchange
  ...
  add("Kirti Nagar",
      {"Kirti Nagar", 5, 0, 0.0, "Green Line", "L5", true}); // interchange
  ...
  add("Jhandewalan",
      {"Ramakrishna Ashram Marg", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Ramakrishna Ashram Marg",
      {"Jhandewalan", 2, 11, 1.0, "Blue Line", "L3", false});
  add("Ramakrishna Ashram Marg",
      {"Rajiv Chowk", 2, 11, 0.9, "Blue Line", "L3", false});
  ...
  add("Mandi House",
      {"Mandi House", 5, 0, 0.0, "Violet Line", "L6", true}); // interchange
  ...
  add("Yamuna Bank",
      {"Akshardham", 2, 11, 1.5, "Blue Line Branch", "L3B", false});
  ...
  add("Karkardooma",
      {"Anand Vihar ISBT", 2, 11, 1.2, "Blue Line", "L3", false});
  add("Anand Vihar ISBT",
      {"Karkardooma", 2, 11, 1.2, "Blue Line", "L3", false});
  ...
  add("Akshardham",
      {"Yamuna Bank", 2, 11, 1.5, "Blue Line Branch", "L3B", false});
  add("Akshardham",
      {"Mayur Vihar Phase-1", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Mayur Vihar Phase-1",
      {"Akshardham", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Mayur Vihar Phase-1",
      {"Mayur Vihar Extension", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Mayur Vihar Phase-1", {"Mayur Vihar Phase-1", 5, 0, 0.0, "Pink Line",
                              "L7", true}); // interchange
  add("Mayur Vihar Extension",
      {"Mayur Vihar Phase-1", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Mayur Vihar Extension",
      {"New Ashok Nagar", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("New Ashok Nagar",
      {"Mayur Vihar Extension", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("New Ashok Nagar",
      {"Noida Sector 15", 3, 21, 2.0, "Blue Line Branch", "L3B", false});
  add("Noida Sector 15",
      {"New Ashok Nagar", 3, 21, 2.0, "Blue Line Branch", "L3B", false});
  add("Noida Sector 15",
      {"Noida Sector 16", 2, 11, 1.1, "Blue Line Branch", "L3B", false});
  add("Noida Sector 16",
      {"Noida Sector 15", 2, 11, 1.1, "Blue Line Branch", "L3B", false});
  add("Noida Sector 16",
      {"Noida Sector 18", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Noida Sector 18",
      {"Noida Sector 16", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Noida Sector 18",
      {"Botanical Garden", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Botanical Garden",
      {"Noida Sector 18", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Botanical Garden",
      {"Golf Course", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Botanical Garden", {"Botanical Garden", 5, 0, 0.0, "Magenta Line", "L8",
                           true}); // interchange
  add("Golf Course",
      {"Botanical Garden", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Golf Course",
      {"Noida City Centre", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Noida City Centre",
      {"Golf Course", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Noida City Centre",
      {"Noida Sector 34", 2, 11, 1.5, "Blue Line Branch", "L3B", false});
  add("Noida Sector 34",
      {"Noida City Centre", 2, 11, 1.5, "Blue Line Branch", "L3B", false});
  add("Noida Sector 34",
      {"Noida Sector 52", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Noida Sector 52",
      {"Noida Sector 34", 2, 11, 1.3, "Blue Line Branch", "L3B", false});
  add("Noida Sector 52",
      {"Noida Sector 61", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Noida Sector 61",
      {"Noida Sector 52", 2, 11, 1.4, "Blue Line Branch", "L3B", false});
  add("Noida Sector 61",
      {"Noida Sector 59", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Noida Sector 59",
      {"Noida Sector 61", 2, 11, 1.2, "Blue Line Branch", "L3B", false});
  add("Noida Sector 59",
      {"Noida Sector 62", 2, 11, 1.1, "Blue Line Branch", "L3B", false});
  add("Noida Sector 62",
      {"Noida Sector 59", 2, 11, 1.1, "Blue Line Branch", "L3B", false});
  add("Noida Sector 62",
      {"Noida Electronic City", 3, 21, 2.2, "Blue Line Branch", "L3B", false});
  add("Noida Electronic City",
      {"Noida Sector 62", 3, 21, 2.2, "Blue Line Branch", "L3B", false});
  ...
  add("Ashok Park Main",
      {"Satguru Ram Singh Marg", 2, 11, 1.2, "Green Line", "L5", false});
  add("Ashok Park Main",
      {"Kirti Nagar", 3, 11, 1.5, "Green Line", "L5", false});
  add("Satguru Ram Singh Marg",
      {"Ashok Park Main", 2, 11, 1.2, "Green Line", "L5", false});
  add("Satguru Ram Singh Marg",
      {"Punjabi Bagh West", 2, 11, 1.1, "Green Line", "L5", false});
  add("Punjabi Bagh West",
      {"Satguru Ram Singh Marg", 2, 11, 1.1, "Green Line", "L5", false});
  add("Punjabi Bagh West",
      {"ESI Hospital", 2, 11, 1.2, "Green Line", "L5", false});
  add("ESI Hospital",
      {"Punjabi Bagh West", 2, 11, 1.2, "Green Line", "L5", false});
  add("ESI Hospital", {"Peeragarhi", 2, 11, 1.1, "Green Line", "L5", false});
  add("Peeragarhi", {"ESI Hospital", 2, 11, 1.1, "Green Line", "L5", false});
  add("Peeragarhi",
      {"Paschim Vihar East", 2, 11, 1.3, "Green Line", "L5", false});
  add("Paschim Vihar East",
      {"Peeragarhi", 2, 11, 1.3, "Green Line", "L5", false});
  add("Paschim Vihar East",
      {"Paschim Vihar West", 2, 11, 0.9, "Green Line", "L5", false});
  add("Paschim Vihar West",
      {"Paschim Vihar East", 2, 11, 0.9, "Green Line", "L5", false});
  ...
  add("Nangloi",
      {"Nangloi Railway Station", 2, 11, 1.0, "Green Line", "L5", false});
  add("Nangloi Railway Station",
      {"Nangloi", 2, 11, 1.0, "Green Line", "L5", false});
  add("Nangloi Railway Station",
      {"Rajdhani Park", 2, 11, 1.1, "Green Line", "L5", false});
  add("Rajdhani Park",
      {"Nangloi Railway Station", 2, 11, 1.1, "Green Line", "L5", false});
  add("Rajdhani Park", {"Mundka", 2, 11, 1.2, "Green Line", "L5", false});
  add("Mundka", {"Rajdhani Park", 2, 11, 1.2, "Green Line", "L5", false});
  add("Mundka",
      {"Mundka Industrial Area", 2, 11, 1.3, "Green Line", "L5", false});
  add("Mundka Industrial Area",
      {"Mundka", 2, 11, 1.3, "Green Line", "L5", false});
  add("Mundka Industrial Area",
      {"Ghevra", 3, 21, 2.0, "Green Line", "L5", false});
  add("Ghevra",
      {"Mundka Industrial Area", 3, 21, 2.0, "Green Line", "L5", false});
  ...
  add("Tikri Border",
      {"Pandit Shree Ram Sharma", 2, 11, 1.1, "Green Line", "L5", false});
  add("Pandit Shree Ram Sharma",
      {"Tikri Border", 2, 11, 1.1, "Green Line", "L5", false});
  add("Pandit Shree Ram Sharma",
      {"Bahadurgarh City Park", 2, 11, 1.3, "Green Line", "L5", false});
  add("Bahadurgarh City Park",
      {"Pandit Shree Ram Sharma", 2, 11, 1.3, "Green Line", "L5", false});
  add("Bahadurgarh City Park",
      {"Brigadier Hoshiyar Singh", 2, 11, 1.2, "Green Line", "L5", false});
  add("Brigadier Hoshiyar Singh",
      {"Bahadurgarh City Park", 2, 11, 1.2, "Green Line", "L5", false});
  ...
  add("Khan Market",
      {"Central Secretariat", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Khan Market",
      {"Jawaharlal Nehru Stadium", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Jawaharlal Nehru Stadium",
      {"Khan Market", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Jawaharlal Nehru Stadium",
      {"Jangpura", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Jangpura",
      {"Jawaharlal Nehru Stadium", 2, 11, 1.2, "Violet Line", "L6", false});
  ...
  add("Lajpat Nagar",
      {"Lajpat Nagar", 5, 0, 0.0, "Pink Line", "L7", true}); // interchange
  ...
  add("Kailash Colony",
      {"Nehru Place", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Nehru Place",
      {"Kailash Colony", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Nehru Place",
      {"Kalkaji Mandir", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Kalkaji Mandir",
      {"Nehru Place", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Kalkaji Mandir",
      {"Govind Puri", 2, 11, 1.1, "Violet Line", "L6", false});
  add("Kalkaji Mandir",
      {"Kalkaji Mandir", 5, 0, 0.0, "Magenta Line", "L8", true}); // interchange
  add("Govind Puri",
      {"Kalkaji Mandir", 2, 11, 1.1, "Violet Line", "L6", false});
  ...
  add("Jasola Apollo",
      {"Sarita Vihar", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Sarita Vihar",
      {"Jasola Apollo", 2, 11, 1.2, "Violet Line", "L6", false});
  ...
  add("Tughlakabad",
      {"Badarpur Border", 2, 11, 1.5, "Violet Line", "L6", false});
  add("Badarpur Border",
      {"Tughlakabad", 2, 11, 1.5, "Violet Line", "L6", false});
  ...
  add("NHPC Chowk",
      {"Mewala Maharajpur", 2, 11, 1.1, "Violet Line", "L6", false});
  add("Mewala Maharajpur",
      {"NHPC Chowk", 2, 11, 1.1, "Violet Line", "L6", false});
  add("Mewala Maharajpur",
      {"Sector 28", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Sector 28",
      {"Mewala Maharajpur", 2, 11, 1.2, "Violet Line", "L6", false});
  ...
  add("Old Faridabad",
      {"Neelam Chowk Ajronda", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Neelam Chowk Ajronda",
      {"Old Faridabad", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Neelam Chowk Ajronda",
      {"Bata Chowk", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Bata Chowk",
      {"Neelam Chowk Ajronda", 2, 11, 1.3, "Violet Line", "L6", false});
  add("Bata Chowk",
      {"Escorts Mujesar", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Escorts Mujesar",
      {"Bata Chowk", 2, 11, 1.2, "Violet Line", "L6", false});
  add("Escorts Mujesar",
      {"Sant Surdas (Sihi)", 3, 21, 2.1, "Violet Line", "L6", false});
  add("Sant Surdas (Sihi)",
      {"Escorts Mujesar", 3, 21, 2.1, "Violet Line", "L6", false});
  add("Sant Surdas (Sihi)", {"Raja Nahar Singh (Ballabhgarh)", 3, 21, 2.0,
                             "Violet Line", "L6", false});
  add("Raja Nahar Singh (Ballabhgarh)",
      {"Sant Surdas (Sihi)", 3, 21, 2.0, "Violet Line", "L6", false});
  ...
  add("Durgabai Deshmukh South Campus",
      {"Hauz Khas", 3, 21, 2.0, "Pink Line", "L7", false});
  add("Durgabai Deshmukh South Campus",
      {"Sir Vishweshwaraiah Moti Bagh", 2, 11, 1.3, "Pink Line", "L7", false});
  add("Durgabai Deshmukh South Campus",
      {"Durgabai Deshmukh South Campus", 5, 0, 0.0, "Yellow Line", "L2",
       true}); // interchange
  add("South Campus",
      {"Durgabai Deshmukh South Campus", 0, 0, 0.0, "Pink Line", "L7", false});
  add("Sir Vishweshwaraiah Moti Bagh",
      {"Durgabai Deshmukh South Campus", 2, 11, 1.3, "Pink Line", "L7", false});
  add("Sir Vishweshwaraiah Moti Bagh",
      {"Bhikaji Cama Place", 2, 11, 1.2, "Pink Line", "L7", false});
  add("Bhikaji Cama Place",
      {"Sir Vishweshwaraiah Moti Bagh", 2, 11, 1.2, "Pink Line", "L7", false});
  add("Bhikaji Cama Place",
      {"Sarojini Nagar", 2, 11, 1.1, "Pink Line", "L7", false});
  add("Sarojini Nagar",
      {"Bhikaji Cama Place", 2, 11, 1.1, "Pink Line", "L7", false});
  add("Sarojini Nagar", {"INA", 2, 11, 1.2, "Pink Line", "L7", false});
  add("South Extension",
      {"Lajpat Nagar", 2, 11, 1.2, "Pink Line", "L7", false});
  add("South Extension",
      {"Greater Kailash", 2, 11, 1.3, "Pink Line", "L7", false});
  add("Greater Kailash",
      {"South Extension", 2, 11, 1.3, "Pink Line", "L7", false});
  add("Greater Kailash",
      {"Chirag Delhi", 2, 11, 1.2, "Pink Line", "L7", false});
  add("Chirag Delhi",
      {"Greater Kailash", 2, 11, 1.2, "Pink Line", "L7", false});
  add("Chirag Delhi",
      {"Panchsheel Park", 2, 11, 1.1, "Pink Line", "L7", false});
  add("Panchsheel Park",
      {"Chirag Delhi", 2, 11, 1.1, "Pink Line", "L7", false});
  ...
  add("Gokulpuri",
      {"Maujpur - Babarpur", 2, 11, 1.1, "Pink Line", "L7", false});
  add("Maujpur - Babarpur",
      {"Gokulpuri", 2, 11, 1.1, "Pink Line", "L7", false});
  ...
  // ═══════════════════════════════════════════════════════════════
  add("Dabri Mor - Janakpuri South",
      {"Janakpuri West", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Dabri Mor - Janakpuri South",
      {"Dashrath Puri", 2, 11, 1.1, "Magenta Line", "L8", false});
  add("Dashrath Puri",
      {"Dabri Mor - Janakpuri South", 2, 11, 1.1, "Magenta Line", "L8", false});
  add("Dashrath Puri", {"Palam", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Palam", {"Dashrath Puri", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Palam",
      {"Sadar Bazaar Cantonment", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Sadar Bazaar Cantonment",
      {"Palam", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Sadar Bazaar Cantonment",
      {"Terminal 1 IGI Airport", 2, 11, 1.4, "Magenta Line", "L8", false});
  add("Terminal 1 IGI Airport",
      {"Sadar Bazaar Cantonment", 2, 11, 1.4, "Magenta Line", "L8", false});
  add("Terminal 1 IGI Airport",
      {"Shankar Vihar", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Shankar Vihar",
      {"Terminal 1 IGI Airport", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Shankar Vihar",
      {"Vasant Vihar", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Vasant Vihar",
      {"Shankar Vihar", 2, 11, 1.3, "Magenta Line", "L8", false});
  ...
  add("Panchsheel Park (Magenta)",
      {"Hauz Khas", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Panchsheel Park (Magenta)",
      {"Chirag Delhi", 2, 11, 1.1, "Magenta Line", "L8", false});
  add("Saket G Block",
      {"Chirag Delhi", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Saket G Block",
      {"Malviya Nagar (Magenta)", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Malviya Nagar (Magenta)",
      {"Saket G Block", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Malviya Nagar (Magenta)",
      {"Kalkaji Mandir", 2, 11, 1.1, "Magenta Line", "L8", false});
  add("Okhla NSIC",
      {"Kalkaji Mandir", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Okhla NSIC", {"Sukhdev Vihar", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Sukhdev Vihar", {"Okhla NSIC", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Sukhdev Vihar",
      {"Jamia Millia Islamia", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Jamia Millia Islamia",
      {"Sukhdev Vihar", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Jamia Millia Islamia",
      {"Okhla Vihar", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Okhla Vihar",
      {"Jamia Millia Islamia", 2, 11, 1.2, "Magenta Line", "L8", false});
  add("Okhla Vihar",
      {"Jasola Vihar Shaheen Bagh", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Jasola Vihar Shaheen Bagh",
      {"Okhla Vihar", 2, 11, 1.3, "Magenta Line", "L8", false});
  add("Jasola Vihar Shaheen Bagh",
      {"Kalindi Kunj", 2, 11, 1.4, "Magenta Line", "L8", false});
  add("Kalindi Kunj",
      {"Jasola Vihar Shaheen Bagh", 2, 11, 1.4, "Magenta Line", "L8", false});
  add("Kalindi Kunj",
      {"Okhla Bird Sanctuary", 2, 11, 1.5, "Magenta Line", "L8", false});
  add("Okhla Bird Sanctuary",
      {"Kalindi Kunj", 2, 11, 1.5, "Magenta Line", "L8", false});
  add("Okhla Bird Sanctuary",
      {"Botanical Garden", 3, 21, 2.0, "Magenta Line", "L8", false});
  ...
  // ═══════════════════════════════════════════════════════════════
  add("Shivaji Stadium (AEL)",
      {"New Delhi", 4, 60, 2.0, "Airport Express", "AEL", false});
  add("Shivaji Stadium (AEL)",
      {"Dhaula Kuan (AEL)", 4, 10, 2.5, "Airport Express", "AEL", false});
  add("Dhaula Kuan (AEL)",
      {"Shivaji Stadium (AEL)", 4, 10, 2.5, "Airport Express", "AEL", false});
  add("Dhaula Kuan (AEL)",
      {"IGI Airport T3", 7, 30, 6.0, "Airport Express", "AEL", false});
  add("IGI Airport T3",
      {"Dhaula Kuan (AEL)", 7, 30, 6.0, "Airport Express", "AEL", false});
  add("IGI Airport T3",
      {"Aerocity", 3, 0, 1.5, "Airport Express", "AEL", false});
  add("Aerocity",
      {"IGI Airport T3", 3, 0, 1.5, "Airport Express", "AEL", false});
  add("Aerocity",
      {"Dwarka Sector 21", 8, 10, 5.5, "Airport Express", "AEL", false});
  ...
  // ═══════════════════════════════════════════════════════════════
  add("Sec 42-43",
      {"Sikanderpur", 3, 20, 2.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 42-43",
      {"Sec 53-54", 3, 20, 1.8, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 53-54",
      {"Sec 42-43", 3, 20, 1.8, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 53-54",
      {"Sec 54 Chowk", 2, 20, 1.2, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 54 Chowk",
      {"Sec 53-54", 2, 20, 1.2, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 54 Chowk",
      {"Sec 55-56", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 55-56",
      {"Sec 54 Chowk", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Sec 55-56",
      {"Belvedere Towers", 2, 20, 1.0, "Rapid Metro Gurgaon", "RMG", false});
  add("Belvedere Towers",
      {"Sec 55-56", 2, 20, 1.0, "Rapid Metro Gurgaon", "RMG", false});
  add("Belvedere Towers",
      {"Cyber City", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Cyber City",
      {"Belvedere Towers", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Cyber City",
      {"Phase 3", 2, 20, 1.2, "Rapid Metro Gurgaon", "RMG", false});
  add("Phase 3",
      {"Cyber City", 2, 20, 1.2, "Rapid Metro Gurgaon", "RMG", false});
  add("Phase 3",
      {"Moulsari Avenue", 2, 20, 1.0, "Rapid Metro Gurgaon", "RMG", false});
  add("Moulsari Avenue",
      {"Phase 3", 2, 20, 1.0, "Rapid Metro Gurgaon", "RMG", false});
  add("Moulsari Avenue",
      {"Phase 2", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
  add("Phase 2",
      {"Moulsari Avenue", 2, 20, 1.1, "Rapid Metro Gurgaon", "RMG", false});
